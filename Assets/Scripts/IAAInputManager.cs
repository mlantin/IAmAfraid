...
// This class is (obviously) based on the Google DemoInputManager. I'm trying to modify it to be more conscious 
// the possibility of more than one controller in a scene.
